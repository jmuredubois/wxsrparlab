...
/*------------------------------------------------------------------------*/
// $Author: tza $
//    $URL: svn://mesasrv01/libusbSR/trunk/libusbSR/libusbSR.h $
//    $Rev: 505 $
...
// that uses this DLL.
#if defined(_SR_API_DLL)//using file libusbSR.h, libusbSR.cpp to generate libusbSR.dll
#define SR_API(RETURN) RETURN 
#else //using file libusbSR.h with libusbSR.dll
#define SR_API(RETURN) RETURN 
#endif
...
#include "libusbSRinternal.h"
#endif

#ifdef _SR_USE_DEPRECATED
#include "libusbSRdeprecated.h"
#endif
